...
\definecolor{lightblue}{RGB}{194, 218, 232}
\definecolor{lightyellow}{RGB}{250, 241, 200}
...
\newcommand{\resheading}[1]{{\large \colorbox{lightblue}{\begin{minipage}{\textwidth}{\textbf{#1 \vphantom{p\^{E}}}}\end{minipage}}}}
...
\newcommand\twoTable[3]{\colorbox{lightyellow}{\begin{tabular}{@{}>{\itshape}p{0.12\textwidth}@{ - \hspace{0.5em}}>{\itshape}p{0.12\textwidth}@{\hspace{2em}}p{0.6\textwidth}@{}}#1 & #2 & #3 \end{tabular}}}
