...
\newcommand\twoTable[3]{\begin{tabular}{>{\itshape}p{0.12\textwidth}@{ - \hspace{0.5em}}>{\itshape}p{0.12\textwidth}@{\hspace{2em}}p{0.6\textwidth}}#1 & #2 & #3 \end{tabular}}
